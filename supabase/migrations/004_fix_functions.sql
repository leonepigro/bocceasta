-- Fix launch_auction: add FOR UPDATE on player SELECT and team NOT FOUND check
...
-- Fix place_bid: add team NOT FOUND check
...
BEGIN
  ...
  -- Sblocca budget del precedente vincitore (current_price = loro bid corrente)
